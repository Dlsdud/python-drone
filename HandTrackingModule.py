...
class HandDetector:
    ...
    def findPosition(self, img, handNo=0, draw=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            # if draw:
            #     cv2.rectangle(img, (bbox[0] + bbox[2] - 180, bbox[1] + bbox[3] - 180),
            #                   (bbox[0] + bbox[2], bbox[1] + bbox[3] - 120),
            #                   (0, 255, 0), -1)
                # cv2.rectangle(img, (bbox[0] - 50, bbox[1] + 120),
                #               (bbox[0] + bbox[2] + 50, bbox[1] + bbox[3] +50),
                #               (0,0, 255), 2)
